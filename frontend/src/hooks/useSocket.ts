...
export const useSocket = () => {
    ...
    useEffect(() => {
        ...
        newSocket.on('player_joined', (data: { playerId: string; username: string; roomCode?: string }) => {
            console.log('[Socket] player_joined event received:', data)
            // If this is the current player (we just joined), set currentPlayerId and roomCode
